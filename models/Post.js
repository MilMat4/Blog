...
module.exports = Post; // Export the Post model so that it can be imported and used in other parts of the application, enabling CRUD operations on post documents in the database